CREATE TABLE IF NOT EXISTS site_settings (
  ...
  subheadline TEXT,
  footer_text VARCHAR(255) NOT NULL DEFAULT 'Copyright 2026 CodeYourCareer. All rights reserved.',
...
('ee786f3f-cfce-4301-a4f3-0d36ef1b37f0', 'Traffic Analytics', 'analytics', 'Track traffic sources, clicks, and conversions without third-party scripts.', 'bi-bar-chart-line', FALSE, 4)
